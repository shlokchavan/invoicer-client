...
import { ITextareaConfig } from 'src/app/shared/components/rm-textarea/rm-textarea.model'
// import { OtpInputConfig } from '../../shared/components/rm-otp-input/rm-otp-input.model';

export const MasterNameInput: ITextConfig = {
    fieldKey: 'name',
    attributes: {
        label: 'Master Name',
        isMandatory: true,
...
export const MasterDescriptionInput: ITextareaConfig = {
    fieldKey: 'description',
    attributes: {
        label: 'Description',
        isMandatory: true,
        maxlength: 250,
        enableLengthHint: true,
        readonly: true,
        resize: "none",
        autoResize: false,
        minHeight: '66px',
