...
export class OwlDateTimeInputDirective<T>
    ...
    private _dateTimeFilter: ((date: T | null) => boolean) | undefined;
    get dateTimeFilter() {
    ...
    get owlDateTimeInputAriaOwns(): string | any {
    ...
    public ngOnInit(): void {
        if (!this.dtPicker) {
            throw Error(
                `OwlDateTimePicker: the picker input doesn't have any associated rm-date-time component`
            );
        }
    }
