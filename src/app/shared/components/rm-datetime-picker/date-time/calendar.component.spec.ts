...
@Component({
    template: `
        <rm-date-time-calendar
                ...
                (yearSelected)="selectedYear=$event"></rm-date-time-calendar>
    `
})
...
@Component({
    template: `
        <rm-date-time-calendar [selectMode]="selectMode"
                                [pickerMoment]="pickerMoment"
                                [minDate]="minDate"
                                [maxDate]="maxDate"></rm-date-time-calendar>
    `
})
...
@Component({
    template: `
        <rm-date-time-calendar [(selected)]="selected"
                                [selectMode]="selectMode"
                                [pickerMoment]="pickerMoment"
                                [dateFilter]="dateFilter"></rm-date-time-calendar>
    `
})
