    ...
    describe('with OwlNativeDateTimeModule', () => {
        describe('standard DateTimePicker', () => {
            ...
            it('should NOT open dateTimePicker if it is disabled', () => {
                ...
                expect(
                    document.querySelector('rm-date-time-container')
                ).toBeNull();
            ...
            it('input should aria-owns rm-date-time-container after opened in popup mode', fakeAsync(() => {
                ...
                expect((ownedElement as Element).tagName.toLowerCase()).toBe(
                    'rm-date-time-container'
                );
            }));

            it('input should aria-owns rm-date-time-container after opened in dialog mode', fakeAsync(() => {
                testComponent.pickerMode = 'dialog';
                fixture.detectChanges();
...
@Component({
    template: `
        ...
        <rm-date-time [opened]="opened"
                       [disabled]="disabled"
                       [pickerType]="pickerType"
                       [pickerMode]="pickerMode" #dt></rm-date-time>
    `
})
...
@Component({
    template: `
        ...
        <rm-date-time [startAt]="startAt"
                       [pickerType]="pickerType" #dt></rm-date-time>
    `
})
...
@Component({
    template: `
        <input [owlDateTime]="dt" [value]="date">
        <rm-date-time #dt [startAt]="startDate"></rm-date-time>
    `
})
...
@Component({
    template: `
        <input [owlDateTime]="dt" [value]="date">
        <rm-date-time #dt [startView]="startView"
                       (monthSelected)="onMonthSelection()"
                       (yearSelected)="onYearSelection()"></rm-date-time>
    `
})
...
@Component({
    template: `
        <input [(ngModel)]="date" [min]="min" [max]="max"
               [owlDateTime]="dt"
               [owlDateTimeTrigger]="dt">
        <rm-date-time [showSecondsTimer]="true" #dt></rm-date-time>
    `
})
...
@Component({
    ...
    <rm-date-time #dt [startAt]="startAt"></rm-date-time>
  `
})
...
@Component({
    ...
    <rm-date-time (afterPickerOpen)="openedSpy()" (afterPickerClosed)="closedSpy()" #dt></rm-date-time>
  `
})
