...
export class TooltipDirective {
    ...
    get destroyDelay() {
        if (this._destroyDelay) {
            ...
            // return Number(this.getHideDelay()) + Number(this.options['animationDuration' || 'animation-duration']);
            return Number(this.getHideDelay()) + Number(this.options['animation-duration']);
        }
    }
    ...
    getShowDelay() {
        ...
        return this.options['show-delay'];
    }

    getHideDelay() {
        // const hideDelay = this.options['hideDelay'];
        const hideDelay = this.options['hide-delay'];
