import {ChangeDetectorRef, Component, ElementRef, ViewChild, EventEmitter, HostBinding, HostListener, Input, Output, OnDestroy, SimpleChanges, TemplateRef, ContentChild} from '@angular/core';
...
export class CarouselComponent implements OnDestroy {
    ...
    @Input()
    set dataForDOM(data: any) {
        this._dataForDOM = data;
    }
    get dataForDOM() {
        return this._dataForDOM;
    }
    ...
    get loop() {
        if (this.images || this.dataForDOM) {
            return this._loop;
        } else {
            return false;
        }
    ...
    ngOnChanges(changes: SimpleChanges) {
        if (changes.width || changes.height || changes.images || changes.dataForDOM) {
            this.setDimensions();
            this.initCarousel();
            this.carousel.lineUpCells();
            this.ref.detectChanges();
    ...
    getDOM(index) {
        return this.carousel.getDOM(index);
    }
