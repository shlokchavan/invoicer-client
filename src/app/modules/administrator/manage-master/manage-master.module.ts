...
@NgModule({
    imports: [
        ...
        RouterModule.forChild([
            { 
                path: 'sp', component: ManageMasterSPComponent
            },
            // { path: 'sp', component: ManageMasterSPComponent, resolve: { allMasterTypes: ManageMasterSystemResolverService } },
            { path: 'sr', component: ManageMasterSPComponent, resolve: { allMasterTypes: ManageMasterSystemResolverService } },
            // { path: 'client', component: ManageMasterClientComponent, resolve: { allMasterTypes: ManageMasterClientResolverService } }
        ])
    ],
    declarations: [ManageMasterSPComponent, ColorCardComponent, ColorCardItemComponent],
    providers: [
        ManageMasterService,
        ManageMasterSystemResolverService,
    ],
